...
* @Last Modified time: 2015-11-27 17:25:06
*/
...
function getPrettyReferrer() {
    var referrer = document.referrer || '-1',
        idx = referrer.indexOf('?');
    if(idx !== -1) {
        referrer = referrer.substring(0, idx);
    }
    return referrer;
}
